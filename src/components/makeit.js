    ...
    <div className="row bgmakeit  animated fadeIn">
      <div className="offset-md-8 col-md-3 ">
        <div className="text-center">
          <img className="logo animated fadeInUp" src={logo1} alt="logo1" />
          <h1 className="colortextmakeit animated fadeInUp"> MAKE IT </h1>
          <Link to="/learnandcook">
            <button className="btn btn-custom3 hvr-fadenavbar hvr-grow-shadow animated fadeInUp">
              LEARN AND COOK{" "}
            </button>
          </Link>
        </div>
